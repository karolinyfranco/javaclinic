...
public class Main {
    static List<Usuario> usuarios = Persistencia.carregarUsuarios();
    static List<Medico> medicos = Persistencia.carregarMedicos();
    static List<Paciente> pacientes = Persistencia.carregarPacientes();
    ...
    private static void realizarLogin() {
        Usuario usuario = SistemaLogin.realizarLogin();
        if (usuario == null) {
    ...
    private static void cadastrarMedico() {
        ...
        Medico medico = new Medico(nome, idade, endereco, telefone, crm, especialidade);

        medicos.add(medico);
        Persistencia.salvarMedicos(medicos);
    ...
    private static void cadastrarPaciente() {
        ...
        Paciente paciente = new Paciente(nome, idade, endereco, telefone, cpf);

        pacientes.add(paciente);
        Persistencia.salvarPacientes(pacientes);
